...
import com.deerangle.dacc.android.core.customui.TextInputView

abstract class BaseFragmentWithInput<BINDING : ViewDataBinding, VIEW_MODEL : androidx.lifecycle.ViewModel> (
    @LayoutRes private val layoutResource: Int
) : Fragment(), TextInputView.Delegate {
    ...
    fun showTextInput(viewTag: String?, text: String?, hint: String?) {
        val textInputView = TextInputView(viewTag, text, hint, this)
        childFragmentManager.let { textInputView.show(it, textInputView.tag) }
    }

    abstract override fun textInputViewSubmit(viewTag: String?, text: String?)

    abstract override fun getInputType(): Int
}
